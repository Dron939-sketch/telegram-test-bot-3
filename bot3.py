...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    welcome_text = (
        ...
        f"• Слепые зоны, которые ты не замечаешь\n"
        f"• Паттерн, который повторяется\n"
        f"• Способ выйти из цикла\n\n"
        f"⏱ 7–10 минут"
    )
    keyboard = [
        [InlineKeyboardButton("🚀 Начать тест", callback_data="start_test")],
        [InlineKeyboardButton("💡 Подробнее о тесте", callback_data="show_details")]
    ]
...
async def show_details(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    details_text = (
        ...
        f"<b>2. Мышление</b>\n"
        f"Как ты обрабатываешь информацию: анализируешь или доверяешь интуиции, контролируешь или плывёшь по течению.\n\n"
        f"<b>3. Поведение</b>\n"
